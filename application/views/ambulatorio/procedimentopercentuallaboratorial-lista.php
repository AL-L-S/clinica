...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_voltar">
        <a href="<?= base_url() ?>ambulatorio/procedimentoplano/conveniopercentuallaboratorio">
            Voltar
        </a>
    </div>
    <table>
        <tr>
            <td>
                <div class="bt_link_new">
                    <a href="<?php echo base_url() ?>ambulatorio/procedimentoplano/procedimentopercentuallaboratorio/<?=$convenio_id?>">
                        Novo Procedimento
                    </a>
                </div>
            </td>
    ...
    <div id="accordion">
        ...
        <div>
            <table>
                ...
                <form method="get" action="<?= base_url() ?>ambulatorio/procedimentoplano/procedimentoconveniopercentuallaboratorial/<?=$convenio_id?>">
                    <tr>
...
<!--                            <select name="grupo" id="grupo" class="size2">
            ...
            <table>
                ...
                $consulta = $this->procedimentoplano->listarprocedimentoconveniopercentuallaboratorio($convenio_id);
//                var_dump($consulta); die;
                ...
                if ($total > 0) {
                    ...
                    <tbody>
                        <?php
                        $lista = $this->procedimentoplano->listarprocedimentoconveniopercentuallaboratorio($convenio_id)->orderby('c.nome')->limit($limit, $pagina)->get()->result();
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="100px;">
                                    <a onclick="javascript: return confirm('Deseja realmente excluir o procedimento');"
                                       href="<?= base_url() ?>ambulatorio/procedimentoplano/excluirpercentuallaboratorio/<?= $item->procedimento_percentual_laboratorio_id; ?>/<?=$convenio_id?>">Excluir&nbsp;
                                    </a>
                                    <a 
                                        href="<?= base_url() ?>ambulatorio/procedimentoplano/editarprocedimentolaboratorial/<?= $item->procedimento_percentual_laboratorio_id; ?>/<?=$convenio_id?>">Editar
                                    </a>  
                                </td>
                            </tr>
