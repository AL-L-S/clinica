...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>ambulatorio/empresa/configurarlaudo/0">
            Novo Modelo
        </a>
    </div>
    <div id="accordion">
        ...
        <div>
            <table>
                ...
                $consulta = $this->empresa->listarconfiguracaoimpressaolaudo($_GET);
                ...
                if ($total > 0) {
                    ...
                    <tbody>
                        <?php
                        $lista = $this->empresa->listarconfiguracaoimpressaolaudo($_GET)->limit($limit, $pagina)->orderby("empresa_impressao_laudo_id")->get()->result();
                        ...
                        foreach ($lista as $item) {
                            ...
                            <tr>
                               ...
                               <? }
                                ...
                                <td class="<?php echo $estilo_linha; ?>"><div class="bt_link">
                                        <a href="<?= base_url() ?>ambulatorio/empresa/configurarlaudo/<?= $item->empresa_impressao_laudo_id; ?>">Editar</a></div>
                                </td>
                                <?
