                ...
                <fieldset>
                    ...
                    if (count($consultasanteriores) > 0) {
                        foreach ($consultasanteriores as $value) {
                            ...
                            ?>
                            <h6>ULTIMO ATENDIMENTO: <?= $value->procedimento; ?> - DATA: <b><?= substr($value->data, 8, 2) . '/' . substr($value->data, 5, 2) . '/' . substr($value->data, 0, 4); ?> </b> - M&eacute;dico: <b> <?= $value->medico; ?></b> - Convenio:  <?= $value->convenio; ?> - <?= $intervalo->days ?></h6>
