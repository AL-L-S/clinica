<div class="content"> <!-- Inicio da DIV content -->
    ...
    <div id="accordion">
        ...
        <div>
            <form name="form_exameespera" id="form_exameespera" action="<?= base_url() ?>ambulatorio/exame/gravarexametodosfiladecaixa" method="post">
                ...
                <dl class="dl_desconto_lista">
                    ...
                    <dd>
                        ...
                        <input type="hidden" name="txtgrupo" value="<?= $grupo[0]->grupo; ?>" />
