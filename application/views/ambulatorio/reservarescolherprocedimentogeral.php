<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    ...
    <form name="form_exametemp" id="form_exametemp" action="<?= base_url() ?>ambulatorio/exametemp/reservarexametempalterarprocedimentogeral/<?=$agenda_exames_id?>/<?=$paciente_id?>/<?=$medico_id?>" method="post">
