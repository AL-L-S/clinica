...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_voltar">
        <a href="<?= base_url() ?>ambulatorio/procedimentoplano/medicopercentual">
            Voltar
        </a>
    </div>
    <table>
        <tr>
            <td>
                <div class="bt_link_new">
                    <a target="_blank" href="<?php echo base_url() ?>ambulatorio/procedimentoplano/procedimentoconveniopercentualmedico/<?= $medico_id; ?>">
                        Novo Convenio
                    </a>
                </div>
            <td>
            <td>
                <div class="bt_link_new">
                    <a target="_blank" href="<?php echo base_url() ?>ambulatorio/procedimentoplano/ajustarpercentualmedico/<?= $medico_id; ?>">
                        Ajustar Percentuais
                    </a>
                </div>
            </td>
    ...
    <div id="accordion">
        ...
        <div>
            <form method="get" action="<?= base_url() ?>ambulatorio/procedimentoplano/conveniopercentualmedico/<?= $medico_id ?>">
                <table>
                    <thead>
                        <tr>
            ...
            <form id="form_menuitens" action="<?= base_url() ?>ambulatorio/procedimentoplano/excluirpercentualconvenio" method="post" target="_blank">
                ...
                <table>
                    ...
                    $consulta = $this->procedimentoplano->listarpercentualconvenio($medico_id, $_GET);
                    ...
                    if ($total > 0) {
                        ...
                        <tbody>
                            <?php
                            $lista = $this->procedimentoplano->listarpercentualconvenio($medico_id, $_GET)->orderby('c.nome')->limit($limit, $pagina)->get()->result();
                            ...
                            foreach ($lista as $item) {
                                ...
                                <tr>
                                    ...
                                    <td class="<?php echo $estilo_linha; ?>">
                                        <a href="<?= base_url() ?>ambulatorio/procedimentoplano/procedimentoconveniopercentual/<?= $medico_id ?>/<?= $item->convenio_id; ?>">Editar</a>  
                                    </td>
    ...
    <!--                                    <a onclick="javascript: return confirm('Deseja realmente excluir os percentuais associados a esse convenio?');"
                                           href="<?= base_url() ?>ambulatorio/procedimentoplano/excluirpercentualconvenio/<?= $medico_id ?>/<?= $item->convenio_id; ?>">Excluir&nbsp;
                                        </a>-->
