<body bgcolor="#C0C0C0">
    <div class="content"> <!-- Inicio da DIV content -->
        ...
        <div>
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>ambulatorio/guia/gravartransformaorcamentocreditopersonalizado" method="post">
                <fieldset>
                    <table cellspacing="5">
                        <tr>
...
<!--                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="valor1" id="valor1" class="texto02" value="0" onblur="multiplica()"/>
                            </td>
                        </tr>
