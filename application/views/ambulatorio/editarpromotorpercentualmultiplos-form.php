...
<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3 class="singular"><a href="#">Editar Honorários Promotores</a></h3>
        <div>
            <form name="form_procedimentoplano" id="form_procedimentoplano" action="<?= base_url() ?>ambulatorio/procedimentoplano/gravareditarpromotorpercentualmultiplos" method="post">
                <input type="hidden" id="promotor_id" name="promotor_id" value="<?= $promotor_id ?>"/>
                <div class="divTabela">
                    <table id="procedimentos">
                        ...
                        <tr id="trBase">
                            ...
                            <td class="tabela_title" colspan="2">Procedimento</td>
...
<script type="text/javascript">   
    ...
    function excluirSelecionados(){
        ...
        if( confirm("Após essa ação, "+percentuais.length+" registro(s) serão apagado(s). Deseja continuar?") ){
            ...
            window.open('<?= base_url() ?>ambulatorio/procedimentoplano/excluirpromotorpercentualmultiplos?&percentual='+parametro, '_blank');
        }
    }
