...
<div class="content"> <!-- Inicio da DIV content -->
    ...
    <div id="accordion">
        ...
        <h3 class="singular"><a href="#">Sessao Psicologia</a></h3>
        <div>
                ...
                <thead>
                    <tr>
                        ...
                        <th class="tabela_header" width="120px;" colspan="2"><center>A&ccedil;&otilde;es<div class="bt_link_new">
                                    <a href="<?= base_url() ?>ambulatorio/exame/cancelartodospsicologia/<?= $paciente_id ?>">Cancelar todos
                    ...
                    foreach ($lista as $item) {
                        ...
                        <tr>
                            ...
                            <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link_new">
                                    <a href="<?= base_url() ?>ambulatorio/exame/autorizarsessaocadapsicologia/<?= $item->agenda_exames_id ?>/<?= $item->paciente_id ?>/<?= $item->guia_id ?>">Encaminhar p/ Espera
                                    </a></div>
                            </td>
