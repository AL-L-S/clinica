...
<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        ...
        <div>
            ...
            <table>
                <thead>
                <form method="get" action="<?= base_url() ?>ambulatorio/exame/listarmultifuncaomedicopsicologia">
            ...
            <table>
                ...
                $consulta = $this->exame->listarmultifuncaopsicologia($_GET);
                ...
                if ($total > 0) {
                    ...
                    <tbody>
                        <?php
                        $lista = $this->exame->listarmultifuncao2psicologia($_GET)->limit($limit, $pagina)->get()->result();
