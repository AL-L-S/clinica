                    ...
                    <div class="divTabela">
                        ...
                        <table id="procedimentos">
                            <thead>
                                ...
                                <th class="tabela_title valor">Qtde CH</th>
                                <th class="tabela_title valor">Valor CH</th>
                                <th class="tabela_title valor">Qtde Filme</th>
                                <th class="tabela_title valor">Valor Filme</th>
                                <th class="tabela_title valor">Qtde Porte</th>
                                <th class="tabela_title valor">Valor Porte</th>
                                <th class="tabela_title valor">Qtde UCO</th>
                                <th class="tabela_title valor">Valor UCO</th>
                                <th class="tabela_title valor">Valor TOTAL</th>
                                <th class="tabela_title add_conv_sec">Adcionar</th>
                            </thead>
<!--                        </table>        
                        <table>        -->
                            <tbody>
                            ...
                            foreach($procedimento as $item){ ?>
                                <tr class="linhaTabela" id="<?= $item->grupo ?>">
                                    ...
                                    <td><?= $item->grupo ?></td>
                                    <td class="valor"><input type="text" name="qtdech[<?= $i ?>]"  id="qtdech<?= $i ?>" class="texto01" value="0"/></td>
                                    <td class="valor"><input type="text" name="valorch[<?= $i ?>]"  id="valorch<?= $i ?>" class="texto01" value="0"/></td>
                                    <td class="valor"><input type="text" name="qtdefilme[<?= $i ?>]"  id="qtdefilme<?= $i ?>" class="texto01" value="0"/></td>
                                    <td class="valor"><input type="text" name="valorfilme[<?= $i ?>]"  id="valorfilme<?= $i ?>" class="texto01" value="0"/></td>
                                    <td class="valor"><input type="text" name="qtdeporte[<?= $i ?>]"  id="qtdeporte<?= $i ?>" class="texto01" value="0"/></td>
                                    <td class="valor"><input type="text" name="valorporte[<?= $i ?>]"  id="valorporte<?= $i ?>" class="texto01" value="0"/></td>
                                    <td class="valor"><input type="text" name="qtdeuco[<?= $i ?>]"  id="qtdeuco<?= $i ?>" class="texto01" value="0"/></td>
                                    <td class="valor"><input type="text" name="valoruco[<?= $i ?>]"  id="valoruco<?= $i ?>" class="texto01" value="0"/></td>
                                    <td class="valor"><input type="text" name="valortotal[<?= $i ?>]"  id="valortotal<?= $i ?>" class="texto01"/></td>
                                    <td class="add_conv_sec"><input type="checkbox" name="add_conv_sec[<?= $i ?>]"  id="add_conv_sec<?= $i ?>"/></td>
                                </tr>
                            <? 
                            $i++;
                            } ?>
