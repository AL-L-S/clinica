        ...
        <tr>
            <td>
                <div class="bt_link_new">
                    <a href="<?php echo base_url() ?>ambulatorio/procedimentoplano/procedimentoconveniopercentuallaboratorio">
                        Novo Convenio
                    </a>
                </div>
            </td>
...
<!--                        <th class="tabela_header">Procedimento</th>
                ...
                $consulta = $this->procedimentoplano->listarpercentualconveniolaboratorio($_GET);
                ...
                if ($total > 0) {
                    ...
                    <tbody>
                        <?php
                        $lista = $this->procedimentoplano->listarpercentualconveniolaboratorio($_GET)->orderby('c.nome')->limit($limit, $pagina)->get()->result();
//                        echo '<pre>';
//                        var_dump($lista);
//                        die;
