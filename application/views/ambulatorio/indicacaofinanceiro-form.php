<div class="content ficha_ceatox">
    ...
    <form name="form_indicacao" id="form_indicacao" action="<?= base_url() ?>ambulatorio/indicacao/gravarfinanceiro" method="post">
        <fieldset>
            ...
            <div>
                ...
                <input readonly="" type="text" name="txtNome" id="txtNome" class="texto10" value="<?= @$obj->_nome; ?>" />
            </div>
            <div>
                <label>Registro</label>
                <input readonly=""  type="text" name="registro" id="registro" class="texto06" value="<?= @$obj->_registro; ?>" />
            </div>
            <div>
                <label>Grupo</label>
                <select disabled="" name="grupo_id" id="grupo_id" class="size4">
