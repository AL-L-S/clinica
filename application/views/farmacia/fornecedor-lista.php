...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>farmacia/fornecedor/carregarfornecedor/0">
            Novo Fornecedor
        </a>
    </div>
    <div id="accordion">
                ...
                <thead>
                    <tr>
                        <th colspan="5" class="tabela_title">
                            <form method="get" action="<?= base_url() ?>farmacia/fornecedor/pesquisar">
                     ...
                     ?>
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="70px;">                                  
                                    <a href="<?= base_url() ?>farmacia/fornecedor/carregarfornecedor/<?= $item->farmacia_fornecedor_id ?>">Editar</a>
                            </td>
                                <td class="<?php echo $estilo_linha; ?>" width="70px;">                                  
                                    <a onclick="javascript: return confirm('Deseja realmente exlcuir esse Fornecedor?');" href="<?= base_url() ?>farmacia/fornecedor/excluir/<?= $item->farmacia_fornecedor_id ?>">Excluir</a>
                            </td>
                        </tr>
