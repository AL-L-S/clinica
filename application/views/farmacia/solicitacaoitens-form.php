<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    <div class="clear"></div>
    <form name="form_solicitacaoitens" id="form_solicitacaoitens" action="<?= base_url() ?>farmacia/solicitacao/gravaritens" method="post">
        <fieldset>
...
<fieldset>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="<?php echo $estilo_linha; ?>" width="100px;">
                            <a href="<?= base_url() ?>farmacia/solicitacao/excluirsolicitacao/<?= $item->farmacia_solicitacao_itens_id; ?>/<?= $farmacia_solicitacao_id; ?>" class="delete">
                            </a>
    ...
    <br>
<div class="bt_link">                                  
    <a onclick="javascript: return confirm('Deseja realmente Liberar a solicitacao?');" href="<?= base_url() ?>farmacia/solicitacao/liberarsolicitacao/<?= $farmacia_solicitacao_id ?>">Liberar</a>
</div>
</fieldset>
