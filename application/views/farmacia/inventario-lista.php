...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>farmacia/inventario/carregarinventario/0">
            Novo Inventario
        </a>
    </div>
    <div id="accordion">
        ...
        <div>
            <table>
                ...
                <form method="get" action="<?= base_url() ?>farmacia/inventario/pesquisar">
                    <tr>
                        ...
                        foreach ($lista as $item) {
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="70px;"><div class="bt_link">                                  
                                    <a href="<?= base_url() ?>farmacia/inventario/carregarinventario/<?= $item->farmacia_entrada_id ?>">Editar</a></div>
                                </td>
                                <td class="<?php echo $estilo_linha; ?>" width="70px;"> <div class="bt_link">                                 
                                    <a onclick="javascript: return confirm('Deseja realmente exlcuir esse Entrada?');" href="<?= base_url() ?>farmacia/inventario/excluir/<?= $item->farmacia_entrada_id ?>">Excluir</a></div>
                                </td>
                                <td class="<?php echo $estilo_linha; ?>" width="50px;"><div class="bt_link">
                                        <a href="<?= base_url() ?>farmacia/inventario/anexarimagementrada/<?= $item->farmacia_entrada_id ?>">Arquivos</a></div>
                                </td>
                            </tr>
