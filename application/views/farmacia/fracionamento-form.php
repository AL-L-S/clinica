        ...
        <div>
            <form name="form_entrada" id="form_entrada" action="<?= base_url() ?>farmacia/entrada/gravar" method="post">
                ...
                <dl class="dl_desconto_lista">
                    ...
                    <dd>
                        <input type="hidden" name="txtfarmacia_fracionamento_entrada_id" id="txtfarmacia_fracionamento_entrada_id" value="<?= @$obj->_farmacia_entrada_id; ?>" />
                        <input type="hidden" name="txtproduto" id="txtproduto" value="<?= @$obj->_farmacia_produto_id; ?>" />
                        <input type="text" name="txtprodutolabel" id="txtprodutolabel" class="texto10" value="<?= @$obj->_descricao; ?>" />
                    </dd>
                    <dt>
                    <label>Fornecedor</label>
                    </dt>
                    <dd>
                        <input type="hidden" name="txtfornecedor" id="txtfornecedor" value="<?= @$obj->_farmacia_fornecedor_id; ?>" />
                        <input type="text" name="txtfornecedorlabel" id="txtfornecedorlabel" class="texto10" value="<?= @$obj->_fantasia; ?>" />
                    </dd>
                    <dt>
                    <label>Armazem</label>
                    </dt>
...
<script type="text/javascript">
    ...
    $(function() {
        $( "#txtprodutolabel" ).autocomplete({
            source: "<?= base_url() ?>index.php?c=autocomplete&m=produtofarmaciafracionamento",
            minLength: 2,
            focus: function( event, ui ) {
