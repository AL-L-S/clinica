<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        ...
        <div>
            <form name="form_sala" id="form_sala" action="<?= base_url() ?>farmacia/cliente/gravar" method="post">
                ...
                <dl class="dl_desconto_lista">
                    ...
                    <dd>
                        <input type="hidden" name="txtfarmaciaclienteid" class="texto10" value="<?= @$obj->_farmacia_cliente_id; ?>" />
                    ...
                    <dd>
                        <select name="menu" id="menu" class="size4">
                            <? foreach ($menu as $value) : ?>
                                <option value="<?= $value->farmacia_menu_id; ?>"<?
    if (@$obj->_menu == $value->farmacia_menu_id):echo 'selected';
    endif;
