    ...
    <div id="accordion">
        ...
        <div>
            <table>
                <thead>
                    <tr>
                        <th colspan="5" class="tabela_title">
                            <form method="get" action="<?= base_url() ?>estoque/cliente/pesquisar">
                ...
                <tbody>
                    <?php
                        $lista = $this->cliente->listar($_GET)->orderby('nome')->limit($limit, $pagina)->get()->result();
                     ...
                     ?>
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="70px;">                                  
                                    <a onclick="javascript: return confirm('Deseja realmente exlcuir esse Cliente?');" href="<?= base_url() ?>estoque/cliente/excluir/<?= $item->estoque_cliente_id ?>">Excluir</a>
                            </td>
                        </tr>
