<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    <div class="clear"></div>
    <form name="form_solicitacaoitens" id="form_solicitacaoitens" action="<?= base_url() ?>centrocirurgico/centrocirurgico/gravarsolicitacaoprocedimentosalterarconvenio" method="post">
        <?
    ...
    if (count($procedimentos) > 0) {
        ...
        <table id="table_agente_toxico" border="0" style="width:600px">
            ...
            <tbody>
                ...
                <center>
                    <a href="<?= base_url() ?>centrocirurgico/centrocirurgico/excluirsolicitacaoprocedimentoeditarconvenio/<?= $item->solicitacao_procedimento_id; ?>/<?= $solicitacao_id; ?>" class="delete">
                    </a>
                </center>
                        </td>
                </tr>
