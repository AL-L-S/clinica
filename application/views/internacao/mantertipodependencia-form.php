...
<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    <h3>Novo Tipo Dependência</h3>
    <!--<div style="width: 100%">-->
    <form name="form_exametemp" id="form_exametemp" action="<?= base_url() ?>internacao/internacao/gravartipodependencia" method="post">
        <fieldset>
            <legend>Nome</legend>
            <input type="text" id="nome" name="nome" value="<?= @$config[0]->nome ?>"/>
            <input type="hidden" id="internacao_tipo_dependencia_id" name="internacao_tipo_dependencia_id" value="<?= @$internacao_tipo_dependencia_id ?>"/>
            <div style="width: 100%">
                <hr/>
