...
<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    <h3>Editar Impressão</h3>
    <!--<div style="width: 100%">-->
    <form name="form_exametemp" id="form_exametemp" action="<?= base_url() ?>internacao/internacao/gravareditarimpressao/<?=$impressao_id?>/<?=$internacao_id?>" method="post">


        <fieldset>
            <legend>Paciente</legend>
           
            <input name="paciente" type="text" readonly="" class="texto10" value="<?=$internacao[0]->paciente;?>">
        ...
        <fieldset>
            ...
            <textarea style="width: 100%; height:600px;" name="texto" id=""><?= $html ?></textarea>
