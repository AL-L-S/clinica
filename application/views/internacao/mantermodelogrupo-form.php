...
<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    <h3>Modelo Grupo Ficha</h3>
    <!--<div style="width: 100%">-->
        <form name="form_exametemp" id="form_exametemp" action="<?= base_url() ?>internacao/internacao/gravarmodelogrupo" method="post">
            <fieldset>
                <legend>Nome</legend>
                <input type="text" id="nome" name="nome" value="<?= @$config[0]->nome ?>"/>
                <input type="hidden" id="internacao_modelo_grupo_id" name="internacao_modelo_grupo_id" value="<?= @$internacao_modelo_grupo_id ?>"/>

            </fieldset>

            <fieldset>
                 <legend>Modelo</legend>
                <textarea name="texto" id=""><?= @$config[0]->texto ?></textarea>
                <div style="width: 100%">
                    <hr/>
