                    ...
                    <tbody>
                        ...
                        foreach ($lista as $item) {
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" style="width: 110px;"><div style="width: 110px;" class="bt_link_new"><a href="<?= base_url() ?>internacao/internacao/mostrafichapaciente/<?= $item->internacao_leito_id ?>">Mais Opções</a></div></td>
