...
<body bgcolor="#C0C0C0">
    <div class="content"> <!-- Inicio da DIV content -->
        <h3 class="singular">Alterar Observação</h3>
        <div>
            <form name="form_horariostipo" id="form_horariostipo" action="<?= base_url() ?>internacao/internacao/gravarobservacaoprecadastro/<?=$internacao_ficha_questionario_id?>" method="post">
                <fieldset>
