<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>giah/operador/novo">
            Novo Operador
        </a>
    </div>
    <div id="accordion">
                ...
                <thead>
                    <tr>
                        <th colspan="5" class="tabela_title">
                            Lista de Operadores
                            <form method="get" action="<?= base_url() ?>giah/operador/pesquisar">
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="140px;">
                                    <a onclick="javascript: return confirm('Deseja realmente excluir o operador <?=$item->usuario; ?>');"
                                       href="<?=base_url()?>giah/operador/excluirOperador/<?=$item->operador_id;?>">
                                        <img border="0" title="Excluir" alt="Excluir"
                                     src="<?=  base_url()?>img/form/page_white_delete.png" />
                                    </a>
                                    <a href="<?= base_url() ?>giah/operador/alteraSenha/<?= $item->operador_id ?>">
