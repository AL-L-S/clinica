    ...
    <div id="accordion">
        ...
        <? if ($item->situacao_id == 21) : ?>
                            <a onclick="javascript: return confirm('Deseja realmente fechar essa compet&ecirc;cia?');"
                               href="<?=  base_url()?>giah/competencia/fechar/<?=$item->competencia?>">
...
<? endif; ?>
        ...
        <div>
            <form name="form_competencia" id="form_competencia" action="<?=base_url() ?>giah/competencia/gravar" method="post">
                <dl>
                    <dt>
