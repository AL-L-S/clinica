<div class="content ficha_ceatox">
    ...
    <form name="evolucao_form" id="evolucao_form" action="<?=base_url() ?>emergencia/emergencia/gravarevolucao/<?= "$ficha"?>" method="POST">
        <fieldset>
            ...
            <div>
                <label>Idade</label>
                <input type="text" name="txtIdade" id="txtIdade" alt="numeromask" class="size2" />
            </div>
            <div>
                <label>Leito</label>
            ...
            <div>
                ...
                <select name="txtUrgencia" id="txtUrgencia" class="size2">
                    <option value="">Selecione</option>
...
$(document).ready(function(){
    ...
    $('#plusparecer').click(function(){
        ...
        linha += "<td>";
        linha += "<select  name='txtInfusaoDrogas["+idlinhaparecer+"]' class='size2'>";
        linha += "<option value='-1'>Selecione</option>";
