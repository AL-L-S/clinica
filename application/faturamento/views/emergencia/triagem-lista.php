<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3><a href="#">Manter fila de triagem</a></h3>
        <div>
            <table>
                <thead>
                    <tr>
                ...
                <form method="get" action="<?php echo base_url() ?>emergencia/triagem/pesquisar">
                ...
                $consulta = $this->triagem->listar($_GET);
                ...
                if ($total > 0) {
                    ...
                    <tbody>
                        <?php
                        $lista = $this->triagem->listar($_GET)->orderby('nascimento')->limit($limit, $pagina)->get()->result();
                        ...
                        foreach ($lista as $item) {
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="70px;">
                                    <div class="bt_link">
                                    <a href="<?= base_url() ?>emergencia/triagem/nova/<?= $item->paciente_id ?>">triagem
                                        </a>
                                        </div>
                                    </td>
                                    <td class="<?php echo $estilo_linha; ?>" width="70px;">
