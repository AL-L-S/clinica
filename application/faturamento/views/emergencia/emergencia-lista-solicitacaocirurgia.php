                ...
                <thead>
                    <tr>
                        <th colspan="5" class="tabela_title">
                            <form name="form_busca" method="post" action="<?= base_url() ?>emergencia/emergencia/pesquisarsoliciatacirurgia">
                    ...
                    <tr>
                        ...
                        <td class="<?=$classe;?>">
                            <a onclick="javascript: return confirm('Deseja realmente retirar da lista o paciente: <?=$item->nome;?>');"
                                href="<?=  base_url()?>emergencia/emergencia/cirurgiasaidafila/<?=$item->cirurgia_id;?>">
