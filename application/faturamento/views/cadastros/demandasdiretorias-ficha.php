<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        ...
        <form name="form_paciente" id="form_paciente" action="<?= base_url() ?>cadastros/pacientes/gravardemanda" method="post">
            <fieldset>
                <dl id="dl_form_servidor">
                    ...
                    <dd class="dd_texto">
                        <textarea cols="" rows="" name="txtDemanda"  class="texto_area"></textarea>
                    </dd>
                    <dt>
