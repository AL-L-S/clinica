<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        ...
        <div>
            <form name="form_sala" id="form_sala" action="<?= base_url() ?>cadastros/subclasse/gravar" method="post">
                ...
                <dl class="dl_desconto_lista">
                    ...
                    <dd>
                        <input type="hidden" name="txtfinanceirosub_classeid" class="texto10" value="<?= @$obj->_financeiro_sub_classe_id; ?>" />
...
<script type="text/javascript">
    $('#btnVoltar').click(function() {
        $(location).attr('href', '<?= base_url(); ?>cadastros/subclasse');
    });
