...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>ponto/horariostipo/novohorariofixo/<?=$horariotipo;?>">
            Nova Horario
        </a>
    </div>
    <div id="accordion">
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="100px;">
                                    <a onclick="javascript: return confirm('Deseja realmente excluir o horario');"
                                       href="<?=base_url()?>ponto/horariostipo/excluirhorariofixo/<?=$item->horariofixo_id;?>/<?=$horariotipo;?>">
