...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>ponto/horariostipo/novohorariovariavel/<?=$horariotipo;?>">
            Nova Horario
        </a>
    </div>
    <div id="accordion">
        <h3 class="singular"><a href="#">Manter Horario Variavel</a></h3>
        <div>
            <table>
                <thead>
                    <tr>
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="100px;">
                                    <a onclick="javascript: return confirm('Deseja realmente excluir o horario');"
                                       href="<?=base_url()?>ponto/horariostipo/excluirhorariovariavel/<?=$item->horariovariavel_id;?>/<?=$horariotipo;?>">
