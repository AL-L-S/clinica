...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>ponto/funcao/carregar/0">
        ...
        <div>
            <table>
                <thead>
                    <tr>
                        <th colspan="5" class="tabela_title">
                            <form method="get" action="<?= base_url() ?>ponto/funcao/pesquisar">
                ...
                <?php
                    ...
                    $consulta = $this->funcao->listar($_GET);
                ...
                <tbody>
                    <?php
                        $lista = $this->funcao->listar($_GET)->limit($limit, $pagina)->get()->result();
                            ...
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="100px;">
                                    <a onclick="javascript: return confirm('Deseja realmente excluir o servidor <?=$item->nome; ?>');"
                                       href="<?=base_url()?>ponto/funcao/excluir/<?=$item->funcao_id;?>">
                                        <img border="0" title="Excluir" alt="Excluir"
                                     src="<?=  base_url()?>img/form/page_white_delete.png" />
                                    </a>
                                    <a href="<?= base_url() ?>ponto/funcao/carregar/<?= $item->funcao_id ?>">
