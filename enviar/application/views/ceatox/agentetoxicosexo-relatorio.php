...
<h5>Casos Registrados de Intoxicação Humana por AGENTE TÓXICO x SEXO </h5>
...
<table>
        ...
        <thead>
<?php $listaCirc = $this->ceatoxrelatorio_m->listarSexo();?>
        <tr>
            <th>Agente T&oacute;xico</th>
       <?php foreach ($listaCirc as $item){?>

                <th width="100px;">
                    <?php echo $item->descricao_sexo;?>
                </th>
...
<?php
     ...
     $lista2 = $this->ceatoxrelatorio_m->listarSexo();
     $iant = 0;?>
   ...
   <?php foreach ($lista as $item) { ?>
        ...
        <?php foreach ($lista2 as $item2) {
          ...
          <td width="100px;"><?php echo $this->ceatoxrelatorio_m->listaTotalAgenteToxicoSexo($i,$j);?></td>


           <?php
          }?>
          <td width="100px;"><?php $totalparcial = $this->ceatoxrelatorio_m->listaParcialAgenteToxico($i);
          echo $totalparcial;
          ?></td>
              <td width="100px;">
                <?php
