...
<h5>Casos Registrados de Intoxicação Humana por AGENTE TÓXICO x CIRCUNSTÂNCIA </h5>
...
<table>
        ...
        <thead>
<?php $listaCirc = $this->ceatoxrelatorio_m->listarCircunstancia();?>
        <tr>
            <th>Agente T&oacute;xico</th>
           <?php foreach ($listaCirc as $item){?>

                    <th width="100px;">
                        <?php echo $item->descricao_circunstancia;?>
                    </th>
...
<?php
     ...
     $lista2 = $this->ceatoxrelatorio_m->listarCircunstancia();
     $iant = 0;?>
   ...
   <?php foreach ($lista as $item) { ?>
        ...
        <?php foreach ($lista2 as $item2) {
           ...
           $j = $item2->codigo_circunstancia;
           $i = str_pad($i, 2,"0",STR_PAD_LEFT);
           $j = str_pad($j, 2,"0",STR_PAD_LEFT);

           ?>

               <td width="100px;"><?php echo $this->ceatoxrelatorio_m->listaTotalAgenteToxicoCircunstancia($i,$j);?></td>
